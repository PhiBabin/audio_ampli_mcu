...
public:
  // Constructor
  ToggleButton(const int8_t pin_in = -1, unsigned long deb_delay = DEFAULT_INPUT_DEBOUNCE_DELAY, PinInMode pin_in_mode = PIM_INT_PULL_UP_RES, unsigned long pressed_duration = 0);
